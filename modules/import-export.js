...
window.toggleCsvDropdown = toggleCsvDropdown;
window.closeCsvDropdown = closeCsvDropdown;
window.exportFullBackupJson = exportFullBackupJson;
window.handleJsonRestore = handleJsonRestore;
window.confirmAndProcessJsonRestore = confirmAndProcessJsonRestore;
window.downloadCsvTemplate = downloadCsvTemplate;
window.findTcgdexMatch = findTcgdexMatch;
window.handleCsvImport = handleCsvImport;
window.processCsvImportRows = processCsvImportRows;
