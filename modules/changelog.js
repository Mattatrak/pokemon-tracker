...
window.LAST_SEEN_CHANGELOG_KEY = LAST_SEEN_CHANGELOG_KEY;
window.CHANGELOG_TYPE_LABELS = CHANGELOG_TYPE_LABELS;
window.renderChangelogEntryChanges = renderChangelogEntryChanges;
window.renderChangelogEntry = renderChangelogEntry;
window.renderChangelogPage = renderChangelogPage;
window.closeChangelogPopup = closeChangelogPopup;
window.acknowledgeChangelogPopup = acknowledgeChangelogPopup;
window.maybeShowChangelogPopup = maybeShowChangelogPopup;
